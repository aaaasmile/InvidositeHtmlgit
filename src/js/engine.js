var Engine = (function(win, doc) {
    ...
    that.addControlPanel = function() {
        that.getElement().prepend(
            "<div id='actions'>"+
                "<span>Nevicata: <span id='weather'><span>nessuna</span></span>"+
                "<a class='snowflakes' href='#'>Fiocchi: <span>on</span></a>"+
                "<a class='animations' href='#'>CSS Animazione: <span>off</span></a>"+
                "<a class='acceleration' href='#'>3D Accelerazione: <span>off</span></a>"+
            "</div>"
        );
